function autocomplete() {
  document.addEventListener("DOMContentLoaded", function() {
    ...
    var flatAddressSearch = document.getElementById('flat_address_search');
    ...
    if (flatAddressSearch) {
      var autocomplete = new google.maps.places.Autocomplete(flatAddressSearch, { types: [ 'geocode' ] });
    }
  });
}
